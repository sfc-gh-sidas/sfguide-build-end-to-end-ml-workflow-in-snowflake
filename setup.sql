...
CREATE OR REPLACE NOTEBOOK DATAOPS_EVENT_PROD.DEFAULT_SCHEMA.E2E_ML_NOTEBOOK_DIST
FROM '@DATAOPS_EVENT_PROD.DEFAULT_SCHEMA.GITHUB_REPO_E2E_SNOW_MLOPS/branches/main/distributed_only/' 
...
ALTER NOTEBOOK DATAOPS_EVENT_PROD.DEFAULT_SCHEMA.E2E_ML_NOTEBOOK SET EXTERNAL_ACCESS_INTEGRATIONS = ( 'pypi_access_integration', 'allow_all_integration');

ALTER NOTEBOOK DATAOPS_EVENT_PROD.DEFAULT_SCHEMA.E2E_ML_NOTEBOOK_DIST ADD LIVE VERSION FROM LAST;
ALTER NOTEBOOK DATAOPS_EVENT_PROD.DEFAULT_SCHEMA.E2E_ML_NOTEBOOK_DIST SET EXTERNAL_ACCESS_INTEGRATIONS = ( 'pypi_access_integration', 'allow_all_integration');
